namespace KYC.Web.DbContexts.KYCDbMigrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.kyc_custriskrating",
                c => new
                    {
                        rrdate = c.DateTime(nullable: false),
                        custid = c.Int(nullable: false),
                        riskitem = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.rrdate, t.custid, t.riskitem })
                .ForeignKey("dbo.CUST", t => t.custid)
                .Index(t => t.custid);
                ...
                c => new
                    {
                        ...
                        Ordinal = c.Double(nullable: false),
                    })
                .PrimaryKey(t => t.id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.id)
                .ForeignKey("dbo.kyc_riskclass", t => t.Class)
                .ForeignKey("dbo.kyc_riskcategory", t => t.Category)
                .Index(t => t.Category)
                .Index(t => t.Class);
        ...
        {
            DropForeignKey("dbo.kyc_riskrating", "Category", "dbo.kyc_riskcategory");
            DropForeignKey("dbo.kyc_riskrating", "Class", "dbo.kyc_riskclass");
            ...
            DropForeignKey("dbo.kyc_custriskrating", "custid", "dbo.CUST");
            DropForeignKey("dbo.CCF", "CustID", "dbo.CUSTUniversal");
            DropIndex("dbo.kyc_riskrating", new[] { "Class" });
            DropIndex("dbo.kyc_riskrating", new[] { "Category" });
            ...
            DropIndex("dbo.kyc_custriskrating", new[] { "custid" });
            ...
            DropTable("dbo.kyc_custriskrating");
            DropTable("dbo.CUST");
